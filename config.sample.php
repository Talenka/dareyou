...
define('SITE_TITLE',   'DareYou!');         // The <title> of the site
define('CRYPT_SALT',   'KM4WcTe+tiPzmkc{'); // The password hashing salt
define('SQL_HOST',     'localhost');        // The MySql database host
