...
$sentences = array(
    ...
    'YOURDATASTAYCONFIDENTIAL' => 'La seule donnée personnelle dont nous avons connaissance est votre pseudo. ' .
        'Votre email n’est sauvegardé dans notre base de données que sous une forme (md5) qui rend très difficile ' .
        'son décodage. De la même manière, votre mot de passe est en sureté grâce à un hachage SHA512 bien salé.',
    ...
    'NOYOUCANTBUYKARMA' => 'Non, pas pour le moment. Le karma est relativement sacré. Si le site devient suffisament ' .
        'populaire et que la guilde des druides de Cournouailles nous donne son accord, nous ouvrirons un compte ' .
        'Paypal, probablement...',

    'How to earn karma points?' => 'Comment gagner des points de karma ?',
    'EARNKARMABYPLAYING' => 'Vous pouvez gagner des points de karma (♣) soit en réalisant des défis, soit en pariant ' .
        'sur le fait qu’un joueur va ou non réaliser un défi. Vous pouvez parier sur vous-même, bien entendu. Si ' .
        'vous réalisez un défi, vous gagnez la moitié des sommes misées pour ou contre vous, plus 10% du total des ' .
        'sommes misées sur ce défi. Si un joueur gagne un défi, tous les parieurs qui avait misé contre lui perdent ' .
        'leur mise. Le montant ainsi récolté est divisé entre les parieurs qui avait misé sur le joueur. Si le ' .
        'joueur perd le défi, c’est le contraire qui se produit.',
    ...
    'Send me a link to reinitialize my password' =>
